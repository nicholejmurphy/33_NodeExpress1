...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2023-05-08T22:00:05.180807" />
  ...
  <link href="/media/css/fontawesome.css?3fc41979" rel="stylesheet">
  <link rel="stylesheet" href="/media/css/bootstrap-4.4.1.min.css">
  <link rel="shortcut icon" href="/favicon.ico" />
  
  <link rel="stylesheet" type="text/css" href="/dyncss/base.css?3fc41979">

  <script src="/media/js/theme.js?3fc41979"></script>
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/pgbouncer-1190-released-2635/">PgBouncer 1.19.0 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2023-05-04 by Peter Eisentraut</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/spa-10-data-privacy-and-security-solution-for-postgres-released-2634/">SPA 1.0: Data privacy and security solution for Postgres, Released!</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2023-05-04 by Cosmic Kayka L.L.C.</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgadmin-4-v71-released-2636/">pgAdmin 4 v7.1 Released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2023-05-04 by pgAdmin Development Team</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/powa-web-414-is-out-2633/">powa-web 4.1.4 is out!</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2023-05-02 by PoWA</li>
              </ul>
            </li>
...
<!-- Blog -->
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5Kp"> Save the Date! PostgreSQL at the 2023 PASS Data Community Summit</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Ryan Booz</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-05-08</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5Ko"> Why Put PostgreSQL in Azure</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5Kq"> Floor Drees</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5Kn"> Should a consultant know everything?</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5Kk"> Postgres 16 highlight - JSON predicates</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Michael Paquier</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-05-07</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5Ki"> PGSQL Phriday #008 – pg_stat_statements</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Andreas Scherbaum</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-05-06</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5Kj"> Track performance differences with pg_stat_statements</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5Kh"> Queries for pg_stat_statements</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Michael Christofides</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-05-05</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5Kg"> pg_stat_statement – Benefits and Shortcomings [PGSQL Phriday #008]</a></h3>
            <ul class="meta">
 ...
 <!-- END SUBMIT A BUG -->
    ...
    <script src="/media/js/main.js?3fc41979"></script>
